...
/* =========================================================
   COMPONENTE: ANIMATED BEAM (Plan B Anti-Errores para Lottie)
   ========================================================= */
const RayoAnimado = () => {
  ...
  return (
    <div className="beam-container">
      ...
      <div className="beam-columna">
        <div className="beam-nodo" title="Figma">
          <i className="fa-brands fa-figma"></i>
        </div>
        <div className="beam-nodo" title="React">
        ...
        <div className="beam-nodo" title="HTML5">
          <i className="fa-brands fa-html5"></i>
        </div>
        <div className="beam-nodo" title="CSS3">
      ...
      <div className="beam-caminos">
        ...
        >
          {/* Caminos base (Grises) */}
          <path
            d="M0 25 C 100 25, 100 200, 200 200"
            className="beam-linea-fondo"
          />
          <path
            d="M0 112.5 C 100 112.5, 100 200, 200 200"
            className="beam-linea-fondo"
          />
          <path
            d="M0 200 C 100 200, 100 200, 200 200"
            className="beam-linea-fondo"
          />
          <path
            d="M0 287.5 C 100 287.5, 100 200, 200 200"
            className="beam-linea-fondo"
          />
          <path
            d="M0 375 C 100 375, 100 200, 200 200"
            className="beam-linea-fondo"
          />
      ...
      {/* Nodo final */}
      <div className="beam-columna">
        <div className="beam-nodo nodo-final">{View}</div>
      </div>
    </div>
  );
};
...
const DisenoWebSiguiente = () => {
  const scrollToForm = (e) => {
    ...
    // ⚠️ Asegúrate de que '#contacto' es el ID real de tu formulario (ej. '#formulario')
    ...
    <section className="servicio-detalle-section">
      <div className="servicio-detalle-container">
        ...
        >
          <h1 className="diseno-title">
            <div className="title-phrase-one">
              ¿Buscas una agencia que diseñe
              <br />
              tu proyecto?
            </div>
            <span className="diseno-text-gradient">
        ...
        <div className="detalle-content-grid">
          ...
          >
            <p>
              Crear una web que funcione no es cuestión de suerte. Para nosotros
              el éxito de un proyecto digital depende de una estrategia sólida,
              no de la improvisación.
            </p>
            <p>
              En <strong>MN Design Web</strong>, nos enfocamos en entregar
              herramientas que generen beneficios. Desarrollamos cada página
              respetando los estándares internacionales de programación y
              optimizando la estructura para el{" "}
              <strong>posicionamiento en buscadores</strong>. Gracias al uso de
              datos estructurados, facilitamos que Google indexe tu contenido
              con total eficacia.
            </p>

            <motion.div 
                className="dw-hero-botones"
            ...
            >
                ...
                <a 
                    ...
                    className="dw-btn-hero-primario"
                >
        ...
        <div className="detalle-cards-grid">
          ...
          >
            ...
            <p>
              Olvida las plantillas genéricas. Construimos tu presencia digital
              desde los cimientos, transformando tu idea en una plataforma web
              sólida, profesional y preparada para escalar desde el primer día.
            </p>
          </motion.div>
          ...
          >
            ...
            <p>
              Si ya dispones de un sitio web pero no refleja la calidad de tus
              servicios o ha quedado obsoleto técnicamente, realizamos una
              transformación profunda. Analizamos tu estructura actual para
              mejorar la experiencia de usuario y actualizar la imagen visual.
            </p>
          </motion.div>
        </div>
      </div>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Conoce al equipo detrás de MN Design Web. Creamos experiencias digitales únicas, desde e-commerce hasta webs con sistemas de reservas. ¡Transformamos tu visión en realidad!"
        />

        <meta
          property="og:title"
          content="Sobre MN Design Web | Tu aliado digital"
        />
        <meta

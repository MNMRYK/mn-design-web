    ...
    <div className="diseno-formulario-area">
      ...
      <form id="diseno-form" onSubmit={handleSubmit}>
        ...
        <div className="diseno-form-grupo">
          ...
          <div className="diseno-checkbox-grid">
            {opcionesServicio.map((opcion, index) => (
              <label key={index} className="diseno-checkbox-label">
                <input type="checkbox" value={opcion} checked={formData.servicios.includes(opcion)} onChange={() => handleCheckboxChange(opcion)} />
                <span className="diseno-checkmark"><i className="fa-solid fa-check"></i></span>
                <span className="diseno-checkbox-text">{opcion}</span>
              </label>
            ))}
          </div>
        </div>
